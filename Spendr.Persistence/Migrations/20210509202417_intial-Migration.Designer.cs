...
namespace Spendr.Persistence.Migrations
{
    ...
    [Migration("20210509202417_intial-Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Spendr.Domain.Entities.Role", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Spendr.Domain.Entities.MerchantAddress", b =>
                {
                    b.HasOne("Spendr.Domain.Entities.Merchant", "Merchant")
                        ...
                        .HasForeignKey("Spendr.Domain.Entities.MerchantAddress", "MerchantId")
                        .OnDelete(DeleteBehavior.ClientCascade);

                    b.HasOne("Spendr.Domain.Entities.Merchant", null)
            ...
            modelBuilder.Entity("Spendr.Domain.Entities.MerchantContact", b =>
                {
                    b.HasOne("Spendr.Domain.Entities.Merchant", "Merchant")
                        .WithOne("MerchantContact")
                        .HasForeignKey("Spendr.Domain.Entities.MerchantContact", "MerchantId")
                        .OnDelete(DeleteBehavior.ClientCascade);
